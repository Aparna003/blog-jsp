		...
		try {
			...
			if(snattbr==null){
				...
				try {
					...
					int rs=stmt.executeUpdate("insert into posts(title,description,author,genre,date) values('"+title+"','"+desc+"','"+author+"','"+gene+"','"+date+"')");
					if(rs>0){
						out.println("<h1>Post added successfully !</h1>");
					}else{
						out.println("<h1>Adding post failed ! Try again</h1>");
					}
				} catch (Exception e) {
